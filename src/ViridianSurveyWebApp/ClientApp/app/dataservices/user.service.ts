...
import { IUserAccount } from '../datamodels/userAccount.model';
...
export class UserService {
    ...
    create(user: IUserAccount) {
        return this.http.post(this.config.apiUrl + '/api/v1/users/register', user, this.jwt());
    }

    update(user: IUserAccount) {
